###this is my r.script for exploring
###using DESeq2
...
# Note any outliers maybe from AH (OA) f2 rep 2
...
#("PCA_F11.png", res=300, height=5, width=5, units="in")
# 
...
png("./myresuts/PCA_allGens.png", res=300, height=5, width=5, units="in")
